...
const Sophia BotStack = require('whatsasena-npm');
const os = require('os');
...
Asena.addCommand({pattern: 'textmaker$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    ...
    const msg = command_cmd + '```.textdevil``` \n' + desc_cmd + t1 + '_\n' + usage_cmd + '.textdevil Sophia Bot_\n\n' +
        command_cmd + '```.text2devil``` \n' + desc_cmd + t55 + '_\n' + usage_cmd + '.text2devil Sophia Bot_\n\n' +
        command_cmd + '```.textbear``` \n' + desc_cmd + t2 + '_\n' + usage_cmd + '.textbear Sophia Bot_\n\n' +
        command_cmd + '```.textwolf``` \n' + desc_cmd + t10 + '_\n' + usage_cmd + '.textwolf Developer;Sophia Bot_\n\n' +
        command_cmd + '```.textneon```\n' + desc_cmd + t3 + '_\n' + usage_cmd + '.textneon Sophia Bot_\n\n' +
        command_cmd + '```.text2neon``` \n' + desc_cmd + t4 + '_\n' + usage_cmd + '.text2neon Sophia Bot_\n\n' +
        command_cmd + '```.text3neon``` \n' + desc_cmd + t18 + '_\n' + usage_cmd + '.text3neon Sophia Bot_\n\n' +
        command_cmd + '```.text4neon``` \n' + desc_cmd + t27 + '_\n' + usage_cmd + '.text4neon Sophia Bot_\n\n' +
        command_cmd + '```.text5neon``` \n' + desc_cmd + t34 + '_\n' + usage_cmd + '.text5neon Sophia Bot_\n\n' +
        command_cmd + '```.text6neon``` \n' + desc_cmd + t77 + '_\n' + usage_cmd + '.text6neon Sophia Bot_\n\n' +
        command_cmd + '```.textlight``` \n' + desc_cmd + t5 + '_\n' + usage_cmd + '.textlight Sophia Bot_\n\n' +
        command_cmd + '```.textjoker``` \n' + desc_cmd + t6 + '_\n' + usage_cmd + '.textjoker Sophia Bot_\n\n' +
        command_cmd + '```.textninja``` \n' + desc_cmd + t7 + '_\n' + usage_cmd + '.textninja Developer;Sophia Bot_\n\n' +
        command_cmd + '```.textglitter``` \n' + desc_cmd + t8 + '_\n' + usage_cmd + '.textglitter Sophia Bot_\n\n' +
        command_cmd + '```.textbokeh``` \n' + desc_cmd + t9 + '_\n' + usage_cmd + '.textbokeh Sophia Bot_\n\n' +
        command_cmd + '```.textmarvel``` \n' + desc_cmd + t11 + '_\n' + usage_cmd + '.textmarvel Developer;Sophia Bot_\n\n' +
        command_cmd + '```.text2marvel``` \n' + desc_cmd + t12 + '_\n' + usage_cmd + '.text2marvel Developer;Sophia Bot_\n\n' +
        command_cmd + '```.textavengers``` \n' + desc_cmd + t13 + '_\n' + usage_cmd + '.textavengers Developer;Sophia Bot_\n\n' +
        command_cmd + '```.textgraf``` \n' + desc_cmd + t15 + '_\n' + usage_cmd + '.textgraf Developer;Sophia Bot_\n\n' +
        command_cmd + '```.text2graf``` \n' + desc_cmd + t16 + '_\n' + usage_cmd + '.text2graf Developer;Sophia Bot_\n\n' +  
        command_cmd + '```.text3graf``` \n' + desc_cmd + t53 + '_\n' + usage_cmd + '.text3graf Sophia Bot_\n\n' +
        command_cmd + '```.text4graf``` \n' + desc_cmd + t67 + '_\n' + usage_cmd + '.text4graf Sophia Bot_\n\n' +
        command_cmd + '```.text5graf``` \n' + desc_cmd + t74 + '_\n' + usage_cmd + '.text5graf Sophia Bot_\n\n' +
        command_cmd + '```.textlion``` \n' + desc_cmd + t17 + '_\n' + usage_cmd + '.textlion Developer;Sophia Bot_\n\n' +
        command_cmd + '```.textice``` \n' + desc_cmd + t19 + '_\n' + usage_cmd + '.textice Sophia Bot_\n\n' +
        command_cmd + '```.textspace``` \n' + desc_cmd + t20 + '_\n' + usage_cmd + '.textspace Developer;Sophia Bot_\n\n' +
        command_cmd + '```.text2space``` \n' + desc_cmd + t68 + '_\n' + usage_cmd + '.text2space Sophia Bot_\n\n' +
        command_cmd + '```.text3space``` \n' + desc_cmd + t72 + '_\n' + usage_cmd + '.text3space Sophia Bot_\n\n' +
        command_cmd + '```.textsmoke``` \n' + desc_cmd + t21 + '_\n' + usage_cmd + '.textsmoke Sophia Bot_\n\n' + // Thanks for @Unique_hunter for base.
        command_cmd + '```.textglow``` \n' + desc_cmd + t23 + '_\n' + usage_cmd + '.textglow Sophia Bot_\n\n' +
        command_cmd + '```.textfire``` \n' + desc_cmd + t25 + '_\n' + usage_cmd + '.textfire Sophia Bot_\n\n' +
        command_cmd + '```.text2fire``` \n' + desc_cmd + t46 + '_\n' + usage_cmd + '.text2fire Sophia Bot_\n\n' +
        command_cmd + '```.text3fire``` \n' + desc_cmd + t73 + '_\n' + usage_cmd + '.text3fire Sophia Bot_\n\n' +
        command_cmd + '```.textharry``` \n' + desc_cmd + t26 + '_\n' + usage_cmd + '.textharry Sophia Bot_\n\n' +
        command_cmd + '```.text2harry``` \n' + desc_cmd + t32 + '_\n' + usage_cmd + '.text2harry Sophia Bot_\n\n' +
        command_cmd + '```.textcup``` \n' + desc_cmd + t29 + '_\n' + usage_cmd + '.textcup Sophia Bot_\n\n' +
        command_cmd + '```.textcemetery``` \n' + desc_cmd + t28 + '_\n' + usage_cmd + '.textcemetery Sophia Bot_\n\n' +
        command_cmd + '```.textstone``` \n' + desc_cmd + t30 + '_\n' + usage_cmd + '.textstone Sophia Bot_\n\n' +
        command_cmd + '```.textgradient``` \n' + desc_cmd + t33 + '_\n' + usage_cmd + '.textgradient Sophia Bot_\n\n' +
        command_cmd + '```.text2gradient``` \n' + desc_cmd + t76 + '_\n' + usage_cmd + '.text2gradient Sophia Bot_\n\n' +
        command_cmd + '```.textmagma``` \n' + desc_cmd + t35 + '_\n' + usage_cmd + '.textmagma Sophia Bot_\n\n' +
        command_cmd + '```.textbglass``` \n' + desc_cmd + t36 + '_\n' + usage_cmd + '.textbglass Sophia Bot_\n\n' +
        command_cmd + '```.textpaper``` \n' + desc_cmd + t37 + '_\n' + usage_cmd + '.textpaper Sophia Bot_\n\n' +
        command_cmd + '```.textmetal``` \n' + desc_cmd + t38 + '_\n' + usage_cmd + '.textmetal Sophia Bot_\n\n' +
        command_cmd + '```.textwcolor``` \n' + desc_cmd + t39 + '_\n' + usage_cmd + '.textwcolor Sophia Bot_\n\n' +
        command_cmd + '```.textart``` \n' + desc_cmd + t40 + '_\n' + usage_cmd + '.textart Sophia Bot_\n\n' +
        command_cmd + '```.text3d``` \n' + desc_cmd + t41 + '_\n' + usage_cmd + '.text3d Developer;Sophia Bot_\n\n' +
        command_cmd + '```.text2light``` \n' + desc_cmd + t42 + '_\n' + usage_cmd + '.text2light Sophia Bot_\n\n' +
        command_cmd + '```.textrobo``` \n' + desc_cmd + t43 + '_\n' + usage_cmd + '.textrobo Sophia Bot_\n\n' +
        command_cmd + '```.textblood``` \n' + desc_cmd + t44 + '_\n' + usage_cmd + '.textblood Sophia Bot_\n\n' +
        command_cmd + '```.text2blood``` \n' + desc_cmd + t45 + '_\n' + usage_cmd + '.text2blood Sophia Bot_\n\n' +
        command_cmd + '```.textpink``` \n' + desc_cmd + t47 + '_\n' + usage_cmd + '.textpink Sophia Bot_\n\n' +
        command_cmd + '```.text2pink``` \n' + desc_cmd + t58 + '_\n' + usage_cmd + '.text2pink Sophia Bot_\n\n' +
        command_cmd + '```.textsand``` \n' + desc_cmd + t48 + '_\n' + usage_cmd + '.textsand Sophia Bot_\n\n' +
        command_cmd + '```.text2sand``` \n' + desc_cmd + t49 + '_\n' + usage_cmd + '.text2sans Sophia Bot_\n\n' +
        command_cmd + '```.text3sand``` \n' + desc_cmd + t50 + '_\n' + usage_cmd + '.text3sand Sophia Bot_\n\n' +
        command_cmd + '```.text4sand``` \n' + desc_cmd + t51 + '_\n' + usage_cmd + '.text4sand Sophia Bot_\n\n' +
        command_cmd + '```.textberry``` \n' + desc_cmd + t52 + '_\n' + usage_cmd + '.textberry Sophia Bot_\n\n' +
        command_cmd + '```.texthub``` \n' + desc_cmd + t54 + '_\n' + usage_cmd + '.texthub Thiccy;Hub_\n\n' +
        command_cmd + '```.textretro``` \n' + desc_cmd + t56 + '_\n' + usage_cmd + '.textretro Developer;Sophia Bot_\n\n' +
        command_cmd + '```.textsci``` \n' + desc_cmd + t57 + '_\n' + usage_cmd + '.textsci Sophia Bot_\n\n' +
        command_cmd + '```.textpubg``` \n' + desc_cmd + t59 + '_\n' + usage_cmd + '.textpubg Sophia Bot_\n\n' +
        command_cmd + '```.textroad``` \n' + desc_cmd + t60 + '_\n' + usage_cmd + '.textroad Sophia Bot_\n\n' +
        command_cmd + '```.textsad``` \n' + desc_cmd + t61 + '_\n' + usage_cmd + '.textsad Sophia Bot_\n\n' +
        command_cmd + '```.textabear``` \n' + desc_cmd + t62 + '_\n' + usage_cmd + '.textabear Sophia Bot_\n\n' +
        command_cmd + '```.textpuppy``` \n' + desc_cmd + t63 + '_\n' + usage_cmd + '.textpuppy Sophia Bot_\n\n' +
        command_cmd + '```.text2pubg``` \n' + desc_cmd + t64 + '_\n' + usage_cmd + '.text2pubg Sophia Bot_\n\n' +
        command_cmd + '```.text3pubg``` \n' + desc_cmd + t65 + '_\n' + usage_cmd + '.text3pubg Sophia Bot_\n\n' +
        command_cmd + '```.textheart``` \n' + desc_cmd + t66 + '_\n' + usage_cmd + '.textheart Sophia Bot_\n\n' +
        command_cmd + '```.textangel``` \n' + desc_cmd + t69 + '_\n' + usage_cmd + '.textangel Sophia Bot_\n\n' +
        command_cmd + '```.textleaf``` \n' + desc_cmd + t70 + '_\n' + usage_cmd + '.textleaf Sophia Bot_\n\n' +
        command_cmd + '```.textgold``` \n' + desc_cmd + t71 + '_\n' + usage_cmd + '.textgold Sophia Bot_\n\n' +
        command_cmd + '```.text2gold``` \n' + desc_cmd + t79 + '_\n' + usage_cmd + '.text2gold Sophia Bot_\n\n' +
        command_cmd + '```.textsnow``` \n' + desc_cmd + t75 + '_\n' + usage_cmd + '.textsnow Sophia Bot_\n\n' +
        command_cmd + '```.textballoon``` \n' + desc_cmd + t78 + '_\n' + usage_cmd + '.textballoon Sophia Bot_\n\n' +
        command_cmd + '```.textmatrix``` \n' + desc_cmd + t80 + '_\n' + usage_cmd + '.textmatrix Sophia Bot_\n\n' +
        command_cmd + '```.textglitch``` \n' + desc_cmd + t14 + '_\n' + usage_cmd + '.textglitch Developer;Sophia Bot_\n\n' +
        command_cmd + '```.text2glitch``` \n' + desc_cmd + t31 + '_\n' + usage_cmd + '.text2glitch Developer;Sophia Bot_'
    ...
    thiccysapi.textpro("https://textpro.me/create-neon-devil-wings-text-effect-online-free-1014.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/devil.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/devil.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-science-fiction-text-effect-online-free-1038.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/sci.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/sci.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Asena.addCommand({pattern: 'textleaf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/dark-green-typography-online-359.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: 'Made by Sophia Bot' })
}));
Asena.addCommand({pattern: 'textmatrix ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/matrix-text-effect-154.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
...
Asena.addCommand({pattern: 'text2gradient ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/create-3d-gradient-text-effect-online-600.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Asena.addCommand({pattern: 'textballoon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/writing-your-name-on-hot-air-balloon-506.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Asena.addCommand({pattern: 'textsnow ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/snow-on-text-online-107.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Asena.addCommand({pattern: 'text2gold ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/gold-text-effect-pro-271.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Asena.addCommand({pattern: 'text5graf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
  var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/graffiti-color-199.html')
  var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
  await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Asena.addCommand({pattern: 'text3fire ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/dragon-fire-text-effect-111.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: 'Made by Sophia Bot' })
}));
Asena.addCommand({pattern: 'text2space ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/create-galaxy-style-free-name-logo-438.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: 'Made by Sophia Bot'})
}));
Asena.addCommand({pattern: 'text3space ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/galaxy-text-effect-116.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: 'Made by Sophia Bot' })
}));
Asena.addCommand({pattern: 'textgold ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/modern-gold-3-212.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: 'Made by Sophia Bot' })
}));
Asena.addCommand({pattern: 'text3space ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'textangel ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/wings-galaxy-206.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: 'Made by Sophia Bot' })
}));
Asena.addCommand({pattern: 'text2pink ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/create-a-blackpink-neon-logo-text-effect-online-710.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: 'Made by Sophia Bot' })
}));
Asena.addCommand({pattern: 'textabear ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/create-funny-animations-of-a-traveling-bear-701.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { caption: 'Made by Sophia Bot', mimetype: Mimetype.gif })
}));
Asena.addCommand({pattern: 'text6neon ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/create-light-effects-green-neon-online-429.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image)
}));
Asena.addCommand({pattern: 'textheart ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/write-name-on-heart-with-wings-gifs-430.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { caption: 'Made by Sophia Bot', mimetype: Mimetype.gif })
}));
Asena.addCommand({pattern: 'text4graf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/text-graffiti-3d-208.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: 'Made by Sophia Bot' })
}));
Asena.addCommand({pattern: 'textpuppy ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/create-puppy-cute-animated-online-478.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { caption: 'Made by Sophia Bot', mimetype: Mimetype.gif })
}));
Asena.addCommand({pattern: 'textroad ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/create-glowing-text-effects-online-706.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: 'Made by Sophia Bot' })
}));
Asena.addCommand({pattern: 'textsad ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/write-text-on-wet-glass-online-589.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: 'Made by Sophia Bot' })
}));
Asena.addCommand({pattern: 'text3pubg ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var img = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/create-the-cover-game-playerunknown-s-battlegrounds-401.html')
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { caption: 'Made by Sophia Bot' })
}));
Asena.addCommand({pattern: 'textpubg ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var vid = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/create-pubg-style-glitch-video-avatar-554.html')
    var buffer_data = await axios.get(vid.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { caption: 'Made by Sophia Bot', mimetype: Mimetype.mp4 })
}));
Asena.addCommand({pattern: 'text2pubg ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    var vid = await Sophia BotStack.ephoto(match[1], 'https://en.ephoto360.com/lightning-pubg-video-logo-maker-online-615.html')
    var buffer_data = await axios.get(vid.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { caption: 'Made by Sophia Bot', mimetype: Mimetype.mp4 })
}));
    ...
    thiccysapi.textpro("https://textpro.me/create-green-horror-style-text-effect-online-1036.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/devil2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/devil2.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/pornhub-style-logo-online-generator-free-977.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/hub.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/hub.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/video-game-classic-8-bit-text-effect-1037.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/retr.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/retr.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/break-wall-text-effect-871.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/t3gr.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/t3gr.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-berry-text-effect-online-free-1033.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/bry.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/bry.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-a-summery-sand-writing-text-effect-988.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/t4snd.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/t4snd.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/sand-engraved-3d-text-effect-989.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/t3snd.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/t3snd.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/sand-writing-text-effect-online-990.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/t2snd.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/t2snd.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/write-in-sand-summer-beach-free-online-991.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/snd.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/snd.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/halloween-fire-text-effect-940.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/fh.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/fh.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/blood-text-on-the-frosted-glass-941.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/tpink.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/tpink.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/blood-text-on-the-frosted-glass-941.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/cbld.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/cbld.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/horror-blood-text-effect-online-883.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/bld.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/bld.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/online-thunder-text-effect-generator-1031.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/t2lgh.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/t2lgh.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/online-thunder-text-effect-generator-1031.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/robo.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/robo.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-layered-text-effects-online-free-1032.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/3dl.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/3dl.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/online-multicolor-3d-paper-cut-text-effect-1016.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/tart.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/tart.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-a-free-online-watercolor-text-effect-1017.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/wcolor.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/wcolor.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-a-magma-hot-text-effect-online-1030.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/magma.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/magma.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-a-3d-glossy-metal-text-effect-1019.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/metal.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/metal.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-art-paper-cut-text-effect-online-1022.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/papert.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/papert.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/broken-glass-text-effect-free-online-1023.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/glass.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/glass.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-3d-neon-light-text-effect-online-1028.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/t5neon.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/t5neon.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/online-3d-gradient-text-effect-generator-1020.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/tgrone.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/tgrone.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-harry-potter-text-effect-online-1025.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/hp2n.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/hp2n.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/3d-stone-cracked-cool-text-effect-1029.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/stone.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/stone.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/online-black-and-white-bear-mascot-logo-creation-1012.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/bear.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/bear.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-wolf-logo-galaxy-online-936.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/wolf.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/wolf.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-a-futuristic-technology-neon-light-text-effect-1006.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/neon.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/neon.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/neon-text-effect-online-879.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/neon2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/neon2.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/thunder-text-effect-online-881.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/li.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/li.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-logo-joker-online-934.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/joker.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/joker.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-ninja-logo-online-935.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/ninja.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/ninja.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/advanced-glow-text-effect-873.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/tt.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/tt.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/bokeh-text-effect-876.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/bkh.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/bkh.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-logo-style-marvel-studios-online-971.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/marvel.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/marvel.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-3d-avengers-logo-online-974.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/mar2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/mar2.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-3d-avengers-logo-online-974.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/aven.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/aven.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-a-glitch-text-effect-online-free-1026.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/t2gl.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/t2gl.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/tt2.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/tt2.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-cool-wall-graffiti-text-effect-online-1009.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/ttgra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/ttgra.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-a-cool-graffiti-text-on-the-wall-1010.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/t2gra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/t2gra.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-lion-logo-mascot-online-938.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/lion.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/lion.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/neon-text-effect-online-963.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/neon3.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/neon3.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/ice-cold-text-effect-862.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/ice.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/ice.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-space-3d-text-effect-online-985.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/space.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/space.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/other-design/create-an-easy-smoke-type-effect-390.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/smoke.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/smoke.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Asena.addCommand({pattern: 'textglow ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    ...
    await download(`https://api.xteam.xyz/photooxy/neonlight?text=${uri}&APIKEY=da5fb2b73ae3e451`, '/root/Sophia BotDuplicated/glowttp.jpg', async() => {                          
        await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/glowttp.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
    })
}));
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/realistic-flaming-text-effect-online-197.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/tfire.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/tfire.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/create-harry-potter-text-on-horror-background-178.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/hp.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/hp.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/illuminated-metallic-effect-177.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/t4n.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/t4n.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/text-on-scary-cemetery-gate-172.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/cmth.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/cmth.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/put-text-on-the-cup-387.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Sophia BotDuplicated/cup.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Sophia BotDuplicated/cup.jpg'), MessageType.image, { caption: 'Made by Sophia Bot' })
              })
          } catch(err) { 
              console.log(err)
          } 
